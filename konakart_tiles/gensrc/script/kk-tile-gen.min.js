...
var kkTmplMap = {
    ...
    kkRoot = "http://localhost:8780/konakart/",
    kkRoot2 = "http://localhost:8780/konakart_tiles/gensrc/",
...
kk.setBannerTileDivId = function(a){
	kk.getProductsTileTemplateContext();
    kkpsContext.bannerDivId = a
};
...
kk.renderHomePage = function() {
    kk.emptyBodyArea();
    $("#body-tile").prepend('<div id="carrusel_b"><ul class="photos_b"><li><img id="foto1" class="banners" src="'+ kkImgBase2+'banner/banner1.jpg"/></li><li><img id="foto2" class="banners" src="'+ kkImgBase2+'banner/banner2.jpg"/></li><li><img id="foto3" class="banners" src="'+ kkImgBase2+'banner/banner3.png"/></li><li><img id="foto4" class="banners" src="'+ kkImgBase2+'banner/banner4.gif"/></li><li><img id="foto5" class="banners" src="'+ kkImgBase2+'banner/banner5.jpg"/></li></ul><ul class="links_b"><li><a href="#foto1">Banner1</a></li><li><a href="#foto2">Banner2</a></li><li><a href="#foto3">Banner3</a></li><li><a href="#foto4">Banner4</a></li><li><a href="#foto5">Banner5</a></li></ul></div>');
    //<img class="kk-rounded-corners" src="' + kkImgBase2 + 'banners/BannerInicio.gif" style="width: 100%;height: 100%;"/>    
    kk.setHomePageCarousel()
};
kk.renderBanner = function(){
	kk.emptyBodyArea();
	$("#banner").prepend('<div id="carrusel_b"><ul class="photos_b"><li><img id="foto1" class="banners" src="'+ kkImgBase2+'banner/banner1.jpg"/></li><li><img id="foto2" class="banners" src="'+ kkImgBase2+'banner/banner2.jpg"/></li><li><img id="foto3" class="banners" src="'+ kkImgBase2+'banner/banner3.png"/></li><li><img id="foto4" class="banners" src="'+ kkImgBase2+'banner/banner4.gif"/></li><li><img id="foto5" class="banners" src="'+ kkImgBase2+'banner/banner5.jpg"/></li></ul><ul class="links_b"><li><a href="#foto1">Banner1</a></li><li><a href="#foto2">Banner2</a></li><li><a href="#foto3">Banner3</a></li><li><a href="#foto4">Banner4</a></li><li><a href="#foto5">Banner5</a></li></ul></div>');
}
kk.setHomePageCarousel = function() {
    var a = new DataDescriptor;
    a.limit = 15;
    var b = new ProductSearch;
    b.categoryId = 35;//cambio
    kkEng.searchForProductsWithOptions(kk.getSessionId(), a, b, kk.getLangId(), kk.getFetchProdOptions(false), function(a) {
        ...
        kk.renderCarousel("carousel-tile", "últimas Refacciones", a)
    }, null, kk.getKKEng())
};
...
kk.storeInit = function() {
    ...
    kkTilePositionInit == false && (kk.setProductsTileDivId("products-tile"), kk.setFacetsTileDivId("facets-tile"), kk.setCatMenuTileDivId("main-menu"), kk.setSearchTileDivId("search-tile"), kk.setPopupCartTileDivId("kk-popup-cart-tile"), kk.setManageCartTileDivId("body-tile"), kk.setPopupWishListTileDivId("kk-popup-wishList-tile"), kk.setManageWishListTileDivId("body-tile"), kk.setProductDetailTileDivId("body-tile"), kk.setLoginLinkDivId("kk-account-link"),
        ...
        kk.setOPCTileDivId("body-tile"), kk.setOrderDetailDivId("body-tile"), kk.setOrdersTileDivId("body-tile"), kk.setWriteReviewTileDivId("body-tile"), kk.setForgotPasswordTileDivId("body-tile"), kk.setBreadcrumbsTileDivId("breadcrumbs-tile"), kk.setBannerTileDivId("banner"), kkTilePositionInit = true);
